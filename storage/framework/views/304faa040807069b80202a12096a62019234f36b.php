...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo e(admin_url('/'), false); ?>"><b style="color:#ffffff;"><?php echo e(config('admin.name'), false); ?></b></a>
  </div>
  <!-- /.login-logo -->
    ...
    <form action="<?php echo e(admin_url('auth/login'), false); ?>" method="post">
      ...
      <div class="row">
        <div class="col-xs-8">
          <?php if(config('admin.auth.remember')): ?>
            <div class="checkbox icheck" >
              <style>.icheckbox_square-blue{border-radius: 20px;border: 1px solid #3c8dbc;}</style>
              <label>
        ...
        <div class="col-xs-4">
          ...
          <button style="border-radius: 20px;" type="submit" class="btn btn-primary btn-block btn-flat"><?php echo e(trans('admin.login'), false); ?></button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<?php /**PATH /Users/ahmeddastagir/Downloads/chatty-app-code/chatty.codemain.top/vendor/encore/laravel-admin/src/../resources/views/login.blade.php ENDPATH**/ ?>